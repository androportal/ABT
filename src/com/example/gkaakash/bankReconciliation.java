...
public class bankReconciliation extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       try {
           ...
           String accountName = menu.selectedAccount;
           String fromDate = menu.givenfromDateString;
           String toDate = menu.givenToDateString;
           boolean cleared_tran_flag = menu.cleared_tran_flag;
           boolean narration_flag = menu.narration_flag;
