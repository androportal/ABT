...
=======
  ...
  #. In each of the report screen, we have following common components:

      - Scroll button, to scroll the screen to the bottom and vice versa.
	  
		.. image:: images/down.jpeg
		   :name: ABT main page
		   :align: center
	  	
      - arrow button, to view respective organisation information such as name, type and financial year in a dialog box.
